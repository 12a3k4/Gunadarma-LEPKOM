CREATE DATABASE PERT6_50421119
USE PERT6_50421119
...
SELECT distinct e.job, d.loc, d.deptno from emp e, dept d
WHERE e.deptno = d.deptno and d.deptno = 30
GROUP BY e.job, d.loc, d.deptno

--2--
SELECT e.EMPNO, e.ENAME, d.DNAME, d.DEPTNO FROM EMP e
LEFT JOIN DEPT D
