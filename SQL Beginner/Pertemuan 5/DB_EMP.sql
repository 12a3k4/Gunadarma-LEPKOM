CREATE DATABASE PERT5_50421119
...
SELECT LOWER(ENAME) AS Nama, LEN(ENAME) AS Panjang
FROM EMP WHERE DEPTNO = 10

---2---
SELECT LEFT(ENAME,3) AS Nickname
FROM EMP WHERE JOB = 'SALESMAN'

---3---
SELECT RIGHT(ENAME,3) AS Nickname
FROM EMP WHERE MGR = 7839

---4---
SELECT ENAME, JOB, SAL, ABS(SAL + (SAL*0.1)) As Total
FROM EMP;

---5---
SELECT DATEPART("DY",GETDATE()) AS Today_Is

---6---
SELECT REVERSE(ENAME) AS Nama_Kebalikan, LOWER(JOB) AS Pekerjaan
FROM EMP